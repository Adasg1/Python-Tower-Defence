...
from src.towers.tower_stats import TowerStats
from src.assets.asset_manager import AssetManager
from src.utils.targeting_utils import dist_to_monster


class Tower(TowerSprite, TowerStats):
    def __init__(self, x, y, tower_type, monsters, game_stats, damage, range, fire_rate, cost):
        TowerStats.__init__(self, game_stats, damage, range, fire_rate, cost)
    ...
    def draw_options(self, surface):
        ...
        if self.counter > 0:
            ...
            self.draw_stats(surface, pos=(self.rect.right+10, self.rect.top))
